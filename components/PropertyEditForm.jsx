        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
          <div>
            <input
              ...
              id="amenity_wifi"
              name="amenities"
              value="Wifi" // -> this value
              className="mr-2"
              defaultChecked={property.amenities.includes("Wifi")} // -> check if it's included in the array
            />
