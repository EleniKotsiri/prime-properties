...
const PropertyContactForm = ({ property }) => {
  ...
  // addMessage returns an object { submitted: true }
  const [state, formAction] = useActionState(addMessage, {});

  useEffect(() => {
    // the addMessage action, on error returns { error }
  ...
  // we get state.submitted from the action (addMessage returns an object { submitted: true })
  if (state.submitted) {
    return (
